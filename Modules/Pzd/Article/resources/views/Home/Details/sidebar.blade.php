<div class="col-lg-4 col-md-12 sidebar-right">
                    ...
                    <li class="mb-20">
                        <div class="d-flex">
                            ...
                            <div class="post-content media-body">
                                <h6 class="post-title mb-10 text-limit-2-row text-sm-right">
                                    <a href="single.html">
                                        {{$article->title}}
                                    </a>
                                </h6>
    ...
    <div class="sidebar-widget mb-30">
        <div class="widget-top-auhor border-radius-10 p-20 bg-white">
            ...
            @foreach($homeRepo->geyAuthorsUsers() as $author)
                <a class="red-tooltip active" href="#" data-toggle="tooltip" data-placement="top" title=""
                   data-original-title="{{$author->name}} - {{$author->articles->count()}} مقاله">
                    <img src="{{asset('assets/imgs/authors/author-2.png')}}" alt="{{$author->name}}">
                </a>
            @endforeach
        ...
        <div class="post-block-list post-module-6">
            @foreach($latestComment as $comment)
                ...
                <span class="item-count vertical-align">
                    <a class="red-tooltip author-avatar" href="#" title="{{$comment->user->name}} - {{$comment->commentable->count()}} پست">
                        <img src="{{$comment->user->image()}}" alt="img user"></a>
                </span>
                    <div class="alith_post_title_small">
                        ...
                        <div class="entry-meta meta-1 font-x-small color-grey float-right  mb-10">
