<aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar position-right">
    ...
    <div class="sidebar-inner">
        ...
        <div class="sidebar-widget widget_tag_cloud mb-50">
            ...
            <div class="tagcloud">
                <a href="{{$category->path()}}">زیبایی</a>
                <a href="{{$category->path()}}">کتاب</a>
                <a href="{{$category->path()}}">طراحی</a>
                <a href="{{$category->path()}}">مد</a>
                <a href="{{$category->path()}}">زندگی</a>
                <a href="{{$category->path()}}">سفر</a>
                <a href="{{$category->path()}}">علم</a>
                <a href="{{$category->path()}}">سلامت</a>
                <a href="{{$category->path()}}">ورزش</a>
                <a href="{{$category->path()}}">هنرها</a>
                <a href="{{$category->path()}}">کتاب</a>
                <a href="{{$category->path()}}">سبک</a>
            </div>
        </div>
        <!--Ads-->
